...
const Game = {
	...
	loop: function() {
		...
		if (isFalling && (isDefined(block.belowLeft) != isDefined(block.belowRight))) {
...
const lvl = [
	...
	[0, 0, 0, 0, 0, 0, M, 0, 0, M, 0, 0, 0, 0, 0, M, M, M, M, M, G, G, G, G, G, G, G, G, G],
	[G, G, G, G, b, b, G, G, G, G, G, G, g, g, g, g, g, G, G, G, G, G, G, G, G, G, G, G, G],
